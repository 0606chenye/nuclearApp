  ...
  return {
    ...
    link: function(scope, element, attrs, parent) {
      ...
      var init = function () {
        ...
        //console.log(attrs.barFixTop);
        //console.log(slider.parent().children()[0]);
        //console.log(tabsBar);
        //var a = slider.parent().children()[0];
        //a.parentNode.insertBefore(tabsBar[0], a.nextElementSibling);
        if(attrs.barFixTop === 'true'){
          slider.parent().prepend(tabsBar);
        }
        else {
          slider.parent()[0].insertBefore(tabsBar[0], slider[0]);
        }

        //a.parentNode.appendChild(tabsBar[0]);

        //slider.parent().children()[0].after(tabsBar);
        compiled(scope);
      ...
      var addEvents = function() {
        ...
        attrs.$observe('currentSlider', function(val) {
          //console.log('$observe currentSlider change:' + val);
          scope.onSlideChange();
        });
